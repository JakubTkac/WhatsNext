...
export function AuthPageShell({
  ...
  return (
    <main className="mx-auto grid w-full max-w-6xl items-start gap-10 px-4 py-12 sm:px-8 sm:py-16 lg:grid-cols-[minmax(0,1fr)_30rem] lg:gap-16 lg:px-12 lg:py-24">
