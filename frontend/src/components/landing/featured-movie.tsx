...
export function FeaturedMovie({ movie }: FeaturedMovieProps) {
  return (
    <Link
      ...
      className="group mt-10 block rounded-[2rem] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-primary"
    >
      <article className="overflow-hidden rounded-[2rem] bg-gradient-to-br from-slate-950 via-blue-950 to-primary-hover text-white shadow-[0_24px_70px_rgba(15,23,42,0.2)] transition-[box-shadow,transform] duration-200 group-hover:-translate-y-1 group-hover:shadow-[0_30px_80px_rgba(15,23,42,0.26)]">
        <div className="grid md:grid-cols-[minmax(0,1fr)_minmax(20rem,32%)]">
          <div className="flex flex-col justify-center px-6 py-10 sm:px-10 sm:py-12 lg:px-14 lg:py-16">
            ...
            <h2 className="mt-6 max-w-3xl text-4xl font-semibold leading-[1.05] tracking-[-0.05em] transition-colors duration-150 group-hover:text-blue-100 sm:text-5xl lg:text-6xl">
              {movie.title}
            </h2>
